...
class PatientWindow(QDialog):
    ...
    def create_layout(self):
        self.setModal(True)
        self.enter_button = QPushButton("Add Patient")
        self.cancel_button = QPushButton("Cancel")
        self.cancel_button.clicked.connect(self.reject)
        
        self.label_forename = QLabel("First Name:")
        ...
        self.label_address1 = QLabel("Address1:")
        self.label_address2 = QLabel("Address2:")
        self.label_address3 = QLabel("Address3:")

        self.add_forename = QLineEdit()
        self.add_surname = QLineEdit()
        self.add_gender = RadioButtonWidget("","",("Male","Female"))
        self.add_dob = BirthDate(1)
    ...
    def add_data(self):
        ...
        if self.add_gender.selected_button == 2:
            Gender = "Female"
        self.add_dob = self.add_dob.day_combo.currentText() + self.add_dob.month_combo.currentText() + self.add_dob.year_combo.currentText()
        data = (self.add_forename.text(), self.add_surname.text(), self.Age, Gender, self.add_dob, self.add_telwork.text(), self.add_telhome.text(), self.add_email.text(), self.add_address1.text(), self.add_address2.text(), self.add_address3.text())
